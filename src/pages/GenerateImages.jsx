import { Hash, HashIcon, Image, Sparkle } from 'lucide-react'

import React, { useState } from 'react'

const GenerateImages = () => {

   const imageStyle = ['Realistic', 'Ghibli Style', 'Anime Style', 'Cartoon Style', 'Potrait Style', 'Fantasy Style', 'Realistic Style'];
...
return(
  <div className='h-full flex overflow-y-scroll p-6 items-start flex-wrap gap-4 text-slate-700'>
      ...
      >
        ...
        <p className='mt-6 text-sm font-medium'>Descibe you image</p>
        <textarea
          rows={4}
          ...
          type="text"
          required
          placeholder='Describe how you want image'
          value={input}
        />
